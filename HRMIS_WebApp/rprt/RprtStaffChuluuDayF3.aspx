<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RprtStaffChuluuDayF3.aspx.cs" Inherits="HRWebApp.rprt.RprtStaffChuluuDayF3" %>
<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
    <h1 class="page-title txt-color-blueDark">
        <i class="fa fa-home fa-fw"></i> > Тайлан <span>> Чөлөө > 2-оос дээш өдрийн чөлөө</span>
    </h1>
</div>
            ...
            <ul class="nav nav-tabs bordered">
                <li id="pTab1Li" class="active">
                    <a data-toggle="tab" href="#pTab1">
                        Ажилтны 2-оос дээш өдрийн чөлөөний тайлан
                    </a>
                </li>
            </ul>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                            <div class="row no-margin">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding margin-bottom-10">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-default pull-right" rel="tooltip" data-placement="top" data-original-title="Word татах" onclick="ExportWord('#divpTab1', 'Ажилтны2оосДээшӨдрийнЧөлөө')">
...
<script type="text/javascript">
    ...
    function dataBindTab1Datatable() {
        ...
        globalAjaxVar = $.ajax({
            type: "POST",
            url: "../webservice/ServiceMain.svc/RprtChuluuDayF3Tab1Table",
