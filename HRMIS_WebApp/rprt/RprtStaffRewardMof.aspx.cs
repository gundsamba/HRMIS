...
{
    public partial class RprtStaffRewardMof : System.Web.UI.Page
    {
        ...
        protected void setDatas()
        {
            ...
            try
            {
                ...
                selectFilterTab1ShagnalType.DataSource = dt;
                selectFilterTab1ShagnalType.DataTextField = "NAME";
                selectFilterTab1ShagnalType.DataValueField = "ID";
                selectFilterTab1ShagnalType.DataBind();
                selectFilterTab1ShagnalType.SelectedIndex = 0;
                dt.Rows.Clear();
                dt = MainClass.getOccupationTypeList("Бүгд");
                selectFilterTab1ShagnalDecision.DataSource = dt;
                selectFilterTab1ShagnalDecision.DataTextField = "NAME";
                selectFilterTab1ShagnalDecision.DataValueField = "ID";
                selectFilterTab1ShagnalDecision.DataBind();
                selectFilterTab1ShagnalDecision.SelectedIndex = 0;
