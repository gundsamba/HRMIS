<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportStaffChuluuTime.aspx.cs" Inherits="HRWebApp.rprt.ReportStaffChuluuTime" %>
<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        <h1 class="page-title txt-color-blueDark">
            <i class="fa fa-home fa-fw"></i> > Тайлан <span>> Чөлөө > Цагийн чөлөө</span>
        </h1>
    </div>
</div>
            ...
            <ul class="nav nav-tabs bordered">
                <li id="pTab1Li" class="active">
                    <a data-toggle="tab" href="#pTab1">
                        Ажилтны цагийн чөлөөний тайлан
                    </a>
                </li>
            </ul>
...
<script type="text/javascript">
    ...
    function dataBindTab1Datatable() {
        ...
        globalAjaxVar = $.ajax({
            type: "POST",
            url: "../webservice/ServiceMain.svc/RprtChuluuTimeTab1Table",
                ...
                if (resData.d.RetType == "0") {
                    if (resData.d.RetData.length != 0) {
                        $(resData.d.RetData).each(function (index, value) {
                            ...
                            valData += '<td style="border: 1px solid #95B3D7; vertical-align: middle;text-align: center; padding: 0 5px;">' + value.DT + ' (' + value.BEGINTM + '-' + value.ENDTM + ')' + '</td>';
                            if(value.TSAG.toString() == '0')valData += '<td style="border: 1px solid #95B3D7; vertical-align: middle;text-align: center; padding: 0 5px;">' + value.MIN + ' мин</td>';
                            else valData += '<td style="border: 1px solid #95B3D7; vertical-align: middle;text-align: center; padding: 0 5px;">' + value.TSAG.toString().split('.')[0] + ' цаг ' + value.MIN + ' мин</td>';
