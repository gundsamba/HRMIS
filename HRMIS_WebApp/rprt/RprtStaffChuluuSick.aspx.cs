...
{
    public partial class RprtStaffChuluuSick : System.Web.UI.Page
    {
        ...
        protected void setDatas()
        {
            ...
            try
            {
                ...
                dt.Rows.Clear();
                dt = MainClass.getChuluuSickType("Бүгд");
                selectFilterTab1Type.DataSource = dt;
                selectFilterTab1Type.DataTextField = "NAME";
                selectFilterTab1Type.DataValueField = "ID";
                selectFilterTab1Type.DataBind();
                selectFilterTab1Type.SelectedIndex = 0;
