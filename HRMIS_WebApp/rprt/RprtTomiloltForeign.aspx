<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RprtTomiloltForeign.aspx.cs" Inherits="HRWebApp.rprt.RprtTomiloltForeign" %>
<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
    <h1 class="page-title txt-color-blueDark">
        <i class="fa fa-home fa-fw"></i> > Тайлан <span>> Томилолт > Гадаад томилолт</span>
    </h1>
</div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                            <div class="row no-margin">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding margin-bottom-10">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-default pull-right" rel="tooltip" data-placement="top" data-original-title="Word татах" onclick="ExportWord('#divpTab1', 'ГадаадТомилолт')">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                            <div class="row no-margin">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding margin-bottom-10">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-default pull-right" rel="tooltip" data-placement="top" data-original-title="Word татах" onclick="ExportWord('#divpTab2', 'АжилтныГадаадТомилолт')">
                                        <i class="fa fa-file-word-o"></i>
                                    </a>
                            ...
                            <div class="row no-margin">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding">
                                    ...
                                    <div id="divpTab2" runat="server" class="reports" style="width: 100%;">
                                        ...
                                        <div style="text-align: center; font-weight: bold; font-size: 14px; padding-bottom: 10px; text-transform: uppercase; line-height: 20px;">
                                            АЖИЛТНЫ ГАДААД ТОМИЛОЛТЫН МЭДЭЭЛЭЛ
                                        </div>
    ...
    function dataBindTab1Datatable() {
        ...
        globalAjaxVar = $.ajax({
            ...
            success: function (data) {
                ...
                valData += '<th style="border: 1px solid #95B3D7; vertical-align: middle;text-align: center; padding: 5px 0;">Аль улс</th>';
                valData += '<th style="border: 1px solid #95B3D7; vertical-align: middle;text-align: center; padding: 5px 0;">Ямар хот</th>';
