<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RprtStaffChuluuSick.aspx.cs" Inherits="HRWebApp.rprt.RprtStaffChuluuSick" %>
<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        <h1 class="page-title txt-color-blueDark">
            <i class="fa fa-home fa-fw"></i> > Тайлан <span>> Чөлөө > Өвчтэй өдрийн чөлөө</span>
        </h1>
    </div>
</div>
            ...
            <ul class="nav nav-tabs bordered">
                <li id="pTab1Li" class="active">
                    <a data-toggle="tab" href="#pTab1">
                        Ажилтны өвчтэй өдрийн чөлөөний тайлан
                    </a>
                </li>
            </ul>
                            ...
                            <div class="well">
                                <form>
                                    <fieldset>
                                        ...
                                        <div class="form-group">
									        <label>Төрөл</label>
									        <select id="selectFilterTab1Type" name="selectFilterTab1Type" runat="server" multiple style="width:100%" class="select2"></select>
								        </div>
                                    </fieldset>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                            <div class="row no-margin">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding margin-bottom-10">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-default pull-right" rel="tooltip" data-placement="top" data-original-title="Word татах" onclick="ExportWord('#divpTab1', 'АжилтныӨвчтэйӨдрийнЧөлөө')">
...
<script type="text/javascript">
    ...
    $("#btnShowTab1").click(function (e) {
        if ($('#selectFilterTab1Branch').select2('data').length > 0 && $("#selectFilterTab1Year option:selected").val() != '' && $('#selectFilterTab1Type').select2('data').length > 0) {
            dataBindTab1Datatable();
        }
        else {
            $('#divAlertTab1Content').html('<div class="alert alert-warning fade in"><button class="close" data-dismiss="alert">×</button><i class="fa-fw fa fa-warning"></i><strong>Анхааруулга</strong> "Он", "Дотоод нэгж", "Төрөл" заавал сонгоно уу!</div>');
        }
    });
    ...
    function dataBindTab1Datatable() {
        ...
        globalAjaxVar = $.ajax({
            type: "POST",
            url: "../webservice/ServiceMain.svc/RprtChuluuSickTab1Table",
                ...
                if (resData.d.RetType == "0") {
                    if (resData.d.RetData.length != 0) {
                        $(resData.d.RetData).each(function (index, value) {
                            ...
                            valData += '<td style="border: 1px solid #95B3D7; vertical-align: middle;text-align: left; padding: 0 5px;">' + value.CHULUUSICKTYPE_NAME + '</td>';
                            valData += "</tr>";
                        });
                    }
                    else {
