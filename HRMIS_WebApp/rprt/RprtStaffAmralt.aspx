<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RprtStaffAmralt.aspx.cs" Inherits="HRWebApp.rprt.RprtStaffAmralt" %>
<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
    <h1 class="page-title txt-color-blueDark">
        <i class="fa fa-home fa-fw"></i> > Тайлан <span>> Ээлжийн амралт</span>
    </h1>
</div>
                            ...
                            <div class="well">
                                <form>
                                    <fieldset>
                                        ...
                                        <div class="form-group">
									        <label>Биеэр эдлэх</label>
									        <select id="selectFilterTab1IsBody" name="selectFilterTab1IsBody" runat="server" multiple style="width:100%" class="select2">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                            <div class="row no-margin">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding margin-bottom-10">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-default pull-right" rel="tooltip" data-placement="top" data-original-title="Word татах" onclick="ExportWord('#divpTab1', 'ЭэлжийнАмралтБаталгаажсанЕрөнхийТайлан')">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding">
                                    ...
                                    <div id="divpTab1" runat="server" class="reports" style="width: 100%;">
                                        ...
                                        <div style="text-align: center; font-weight: bold; font-size: 14px; padding-bottom: 10px; text-transform: uppercase; line-height: 20px;">
                                            Ээлжийн амралт баталгаажсан ерөнхий тайлан
                                        </div>
                                            ...
                                            <table style="border: 1px solid #95B3D7; border-collapse:collapse; width: 100%; font-size:8pt;">
                                                <tbody id="contentTab1Datatable">
                                                    <tr style="background-color: #DBE5F1; -webkit-print-color-adjust:exact;">
                                                        ...
                                                        <th style="border: 1px solid #95B3D7; vertical-align: middle;text-align: center; padding: 5px 0;">Амрах хоног</th>
                                                        <th style="border: 1px solid #95B3D7; vertical-align: middle;text-align: center; padding: 5px 0;">Амарсан хоног</th>
                                                        <th style="border: 1px solid #95B3D7; vertical-align: middle;text-align: center; padding: 5px 0;">Хэднээс хэдэнд</th>
                                                        <th style="border: 1px solid #95B3D7; vertical-align: middle;text-align: center; padding: 5px 0;">Дутуу хоног</th>
                                                    </tr>
                                                    <tr>
...
<script type="text/javascript">
    ...
    var varFilterTab1IsBody = $("#selectFilterTab1IsBody").select2('data');
    ...
    $("#selectFilterTab1Branch, #selectFilterTab1IsBody").change(function (e) {
    ...
    $("#btnShowTab1").click(function (e) {
        if ($('#selectFilterTab1Branch').select2('data').length > 0 && $("#selectFilterTab1Year option:selected").val() != '' && $('#selectFilterTab1IsBody').select2('data').length > 0) {
            dataBindTab1Datatable();
        }
        else {
            $('#divAlertTab1Content').html('<div class="alert alert-warning fade in"><button class="close" data-dismiss="alert">×</button><i class="fa-fw fa fa-warning"></i><strong>Анхааруулга</strong> "Он", "Дотоод нэгж", "Биеэр эдлэх эсэх" заавал сонгоно уу!</div>');
        }
    });
    $("#btnRefreshTab1").click(function (e) {
        ...
        $("#selectFilterTab1IsBody").select2('data', varFilterTab1IsBody);
    });
    ...
    function dataBindTab1Datatable() {
        ...
        jsonData.isbody = $("#selectFilterTab1IsBody").val();
        globalAjaxVar = $.ajax({
            type: "POST",
            url: "../webservice/ServiceMain.svc/RprtAmraltTab1Table",
            ...
            success: function (data) {
                ...
                valData += '<th style="border: 1px solid #95B3D7; vertical-align: middle;text-align: center; padding: 5px 0;">Амрах хоног</th>';
                valData += '<th style="border: 1px solid #95B3D7; vertical-align: middle;text-align: center; padding: 5px 0;">Амарсан хоног</th>';
                valData += '<th style="border: 1px solid #95B3D7; vertical-align: middle;text-align: center; padding: 5px 0;">Хэднээс хэдэнд</th>';
                valData += '<th style="border: 1px solid #95B3D7; vertical-align: middle;text-align: center; padding: 5px 0;">Дутуу хоног</th>';
                valData += '</tr>';
                if (resData.d.RetType == "0") {
                    if (resData.d.RetData.length != 0) {
                        var valAmrah = 0, valAmarsan = 0;
                        $(resData.d.RetData).each(function (index, value) {
                            valAmrah = parseInt(value.AMRAHDAY);
                            valAmarsan = parseInt(value.AMARSANDAYCNT);
                            valData += "<tr>";
                            ...
                            valData += '<td style="border: 1px solid #95B3D7; vertical-align: middle;text-align: center; padding: 0 5px;">' + value.AMRAHDAY + '</td>';
                            valData += '<td style="border: 1px solid #95B3D7; vertical-align: middle;text-align: center; padding: 0 5px;">' + value.AMARSANDAYCNT + '</td>';
                            valData += '<td style="border: 1px solid #95B3D7; vertical-align: middle;text-align: left; padding: 0 5px;">' + value.DTLIST + '</td>';
                            valData += '<td style="border: 1px solid #95B3D7; vertical-align: middle;text-align: center; padding: 0 5px;">' + (valAmrah-valAmarsan) + '</td>';
                            valData += "</tr>";
                        });
                    }
                    else {
