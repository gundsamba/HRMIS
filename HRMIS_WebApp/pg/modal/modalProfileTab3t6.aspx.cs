...
{
    public partial class modalProfileTab3t6 : System.Web.UI.Page
    {
            ...
            else
            {
                ...
                try
                {
                    ...
                    if (Request.QueryString["id"] != null && Request.QueryString["id"] != "" && Request.QueryString["staffsid"] != null && Request.QueryString["staffsid"] != "")
                    {
                        ...
                        ds = myObj.OracleExecuteDataSet(@"SELECT ID, STAFFS_ID, DT, ""NAME"", AMT, TUSHAALNAME, TUSHAALNO, TUSHAALDT, ""DESC"" FROM ST_COMPENSATION WHERE ID = " + Request.QueryString["id"] + " AND STAFFS_ID = " + Request.QueryString["staffsid"]);
