<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="modalProfileTab3t6.aspx.cs" Inherits="HRWebApp.pg.modal.modalProfileTab3t6" %>
                ...
                <fieldset>
                    ...
                    <div class="row">
                        <section class="col col-12">
                            <label class="label">Нөхөх төлбөр олгосон үндэслэл*</label>
...
<script>
    ...
    $("#formProfileTab3t6Modal1").validate({
        rules: {
            inputDt: {
                required: true,
                maxlength: 10
        ...
        submitHandler: function (form) {
            ...
            globalAjaxVar = $.ajax({
                type: "POST",
                url: "../webservice/ServiceMain.svc/SaveProfileTab3T6Datatable1",
                ...
                success: function (data) {
                    ...
                    if (resData.d.RetType == "0") {
                        ...
                        $('#myModalProfileTab3t6').modal('hide');
                        $.smallBox({
