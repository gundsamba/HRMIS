    ...
    public partial class attendance : System.Web.UI.Page
    {
        ...
        protected void setDatas()
        {
            ...
            try
            {
                ...
                selectFilterTab0Year.DataSource = dt;
                selectFilterTab0Year.DataTextField = "YEAR";
                selectFilterTab0Year.DataValueField = "YEAR";
                selectFilterTab0Year.DataBind();
                selectFilterTab0Year.SelectedIndex = selectFilterTab0Year.Items.IndexOf(selectFilterTab0Year.Items.FindByValue(DateTime.Now.Year.ToString()));
                selectFilterTab0Month.SelectedIndex = selectFilterTab0Month.Items.IndexOf(selectFilterTab0Month.Items.FindByValue(DateTime.Now.Month.ToString()));
